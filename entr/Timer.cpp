...
void Timer::raiseInterrupt(int timer)
{
	if (NDS9)
		m_interruptManager->NDS9_requestInterrupt(irqLUT[timer]);
	else
		m_interruptManager->NDS7_requestInterrupt(irqLUT[timer]);
}
