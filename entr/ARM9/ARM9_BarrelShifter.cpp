...
uint32_t ARM946E::LSL(uint32_t val, int shiftAmount, int& carry)
{
	if (shiftAmount >= 32)
	{
		if (shiftAmount == 32)
...
uint32_t ARM946E::LSR(uint32_t val, int shiftAmount, int& carry)
{
...
uint32_t ARM946E::ASR(uint32_t val, int shiftAmount, int& carry)
{
	if (shiftAmount >= 32 || shiftAmount==0)
	{
		carry = ((val >> 31) & 0b1);
...
uint32_t ARM946E::ROR(uint32_t val, int shiftAmount, int& carry)
{
	if (shiftAmount == 0)
	{
...
uint32_t ARM946E::RORSpecial(uint32_t val, int shiftAmount, int& carry)
{
